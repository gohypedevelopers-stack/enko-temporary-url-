...
function DarkRangeCard({ 
  ...
  return (
    <article className="group flex flex-col items-start w-full">
      <div 
        className="w-full aspect-square overflow-hidden bg-steel mb-6 relative rounded-lg cursor-pointer flex items-center justify-center p-8 transition-colors hover:bg-[#2a2a2a]"
        onClick={onToggle}
      >
         <img 
           src={card.image} 
      ...
      <p className="text-[8px] uppercase tracking-widest font-bold text-warm/50 mb-3">
        {card.tag}
      </p>
    ...
    <section className="bg-forge py-24 border-b border-warm/10 relative overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between text-left border-b-2 border-warm/10 pb-4">
          ...
          <p className="max-w-xl text-sm leading-7 text-warm/60 mx-auto lg:mx-0 mb-1 lg:mb-0">
